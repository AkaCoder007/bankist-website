...
message.style.height = Number(getComputedStyle(message).height.slice(0, -2)) + 60 + 'px';
message.style.top = `${clientHeight-message.getBoundingClientRect().height}px`;
...
logo.setAttribute('src', '../starter/img/logo_2.png');
footerLogo.setAttribute('src', '../starter/img/logo_2.png')
...
document.querySelector('.nav__links').addEventListener('click', function(e) {
    ...
    if (that.classList.contains('nav__link')) {
        ...
        document.querySelector(that.getAttribute('href')) && document.querySelector(that.getAttribute('href')).scrollIntoView({ behavior: 'smooth' });
    }
})
...
tabsContainer.addEventListener('click', function(e) {
    ...
    document.querySelector(`.operations__content--${that.dataset.tab}`).classList.add('operations__content--active');
});
